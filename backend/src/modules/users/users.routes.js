...
var usersRoutes = function (app) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        app.get("/me", { preHandler: app.authenticate }, function (request) { return __awaiter(void 0, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, app.prisma.user.findUnique({
                    ...
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, __assign(__assign({}, user), { currentStoreId: request.user.storeId })];
                }
            });
        }); });
        return [2 /*return*/];
